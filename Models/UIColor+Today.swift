...
//  Today
//
//  Created by MacPro on 11.04.2022.
//
...
extension UIColor {
    static var todayDetailCellTint: UIColor {
        UIColor(named: "TodayDetailCellTint") ?? .todayDetailCellTint
    }
    ...
    static var todayListCellDoneButtonTint: UIColor {
        UIColor(named: "TodayListCellDoneButtonTint") ?? .todayListCellDoneButtonTint
    }
    ...
    static var todayPrimaryTint: UIColor {
        UIColor(named: "TodayPrimaryTint") ?? .todayPrimaryTint
    }
